    ...
    <section className="relative py-24 px-6 min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="relative inline-block mb-12">
          ...
          <button className="relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl text-lg font-medium hover:from-blue-500 hover:to-purple-500 transition-all">
