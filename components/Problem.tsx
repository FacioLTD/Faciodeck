      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-300 max-w-3xl mx-auto">
            MGAs control billions in premiums but run on fragile spreadsheets
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-red-900/40 to-orange-900/40 border border-red-500/30 rounded-xl p-8">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="text-xl mb-2 text-white">Legacy Tech is Expensive</h3>
              </div>
            </div>
            <p className="text-slate-300 mb-3">
              Competitors (e.g., Insurance Cloud) cost <span className="text-red-400 font-semibold">$1,350/mo minimum</span> + high implementation fees
            </p>
            <div className="text-sm text-slate-400">
              Out of reach for mid-market MGAs
            </div>
          </div>
